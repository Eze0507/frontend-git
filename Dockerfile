...
ARG VITE_PRICE_ID_BASIC
ARG VITE_PRICE_ID_PRO
ARG VITE_PRICE_ID_ENTERPRISE

ENV VITE_API_URL=${VITE_API_URL}
ENV VITE_STRIPE_PUBLISHABLE_KEY=${VITE_STRIPE_PUBLISHABLE_KEY}
ENV VITE_PRICE_ID_BASIC=${VITE_PRICE_ID_BASIC}
ENV VITE_PRICE_ID_PRO=${VITE_PRICE_ID_PRO}
ENV VITE_PRICE_ID_ENTERPRISE=${VITE_PRICE_ID_ENTERPRISE}
