// Página para que los clientes vean solo sus pagos
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { 
  FaSearch, FaFilter, FaEye, FaMoneyBillWave, FaArrowLeft,
...
const MisPagosPage = () => {
  ...
  const loadPagos = async () => {
    try {
      ...
      console.log('📋 Mis Pagos obtenidos:', response);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-800 mb-2">Mis Pagos</h1>
              <p className="text-gray-600">Consulta el historial de todos tus pagos realizados</p>
            </div>
            <button
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-2">No tienes pagos registrados</p>
              <p className="text-sm text-gray-500">Cuando realices un pago, aparecerá aquí</p>
            </div>
          ) : (
        ...
        {!loading && pagos.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6 mt-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-1">Monto Total Pagado</p>
