...
const ItemVentaList = ({ items, onEdit, onDelete, onAddNew, onView, loading }) => {
  const [searchTerm, setSearchTerm] = React.useState("");

  // Filtrado de ítems de venta según búsqueda
    ...
    <div className="bg-white p-6 rounded-lg shadow-md w-full">
      ...
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-gray-600 mb-2">
          {searchTerm ? 'No se encontraron ítems' : 'No hay ítems de venta registrados'}
        </h3>
        <p className="text-gray-500 mb-6">
          {searchTerm 
            ? `No se encontraron ítems que coincidan con "${searchTerm}"`
            : 'Comienza agregando tu primer ítem de venta al inventario'
          }
        </p>
        {!searchTerm && (
          <Button
